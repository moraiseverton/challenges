...
class WritersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create writer" do
    assert_difference('Writer.count') do
      post writers_url, params: { writer: { name: @writer.name, website: @writer.website, website_headings: @writer.website_headings, website_shortened: @writer.website_shortened } }
    end
  ...
  test "should update writer" do
    patch writer_url(@writer), params: { writer: { name: @writer.name, website: @writer.website, website_headings: @writer.website_headings, website_shortened: @writer.website_shortened } }
